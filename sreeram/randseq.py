...
arg_parser = argparse.ArgumentParser(description='Generate random sequences in a FASTA file format')

arg_parser.add_argument('-num_seqs', required=False, type= int, default=20, metavar='num_of_seqs', help='enter the number of seequences you want to generate (defaults to 20')

arg_parser.add_argument('-len_each' ,required=False, type= int, default=50, metavar='len_each_seq', help='enter the length of a sequence (defaults to 50)')
